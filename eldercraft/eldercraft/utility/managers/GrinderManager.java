...
public class GrinderManager {
	...
	private GrinderManager() {
		...
		this.addGinderRecipe(new ItemStack(Items.PORKCHOP), 200, false,
				new ItemStack(ItemInitialization.PATTYRAWPORK), 225,
				new ItemStack(Items.DYE , 15), 60,
				new ItemStack(Items.LEATHER), 30);
		
		this.addGinderRecipe(new ItemStack(Items.CHICKEN), 300, false,
		...
		this.addGinderRecipe(new ItemStack(Items.RABBIT), 100, false,
				new ItemStack(ItemInitialization.PATTYRAWLEAN), 100,
				new ItemStack(Items.DYE , 15), 10,
				new ItemStack(Items.RABBIT_FOOT), 1);
		
		this.addGinderRecipe(new ItemStack(Items.FISH , 0), 100, false,//normal
		...
		this.addGinderRecipe(new ItemStack(Items.FISH , 1), 200, false,//salmon
				new ItemStack(ItemInitialization.PATTYRAWFISH), 125,
				new ItemStack(Items.DYE , 15), 80,
				new ItemStack(ItemInitialization.FISHSCALES), 80);
		
		this.addGinderRecipe(new ItemStack(Items.FISH , 2), 100, false,//clown
		...
		this.addGinderRecipe(new ItemStack(Items.FISH , 3), 100, false,//puff
