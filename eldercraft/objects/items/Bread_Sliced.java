...
public class Bread_Sliced extends ItemFood implements IHaveModel{
	public Bread_Sliced(String name, int amount, boolean isWolfFood, PotionEffect... potionEffects){
