...
public class PattyChickenRaw extends ItemFood implements IHaveModel{
	public PattyChickenRaw(String name, int amount, boolean isWolfFood, PotionEffect... potionEffects){
