...
public class Patty_ZMeat extends ItemFood implements IHaveModel{
	public Patty_ZMeat(String name, int amount, boolean isWolfFood, PotionEffect... potionEffects){
