...
public class PattyLeanCooked extends ItemFood implements IHaveModel{
	public PattyLeanCooked(String name, int amount, boolean isWolfFood, PotionEffect... potionEffects){
