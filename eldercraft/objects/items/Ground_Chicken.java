...
public class Ground_Chicken extends ItemFood implements IHaveModel{
	public Ground_Chicken(String name, int amount, boolean isWolfFood, PotionEffect... potionEffects){
