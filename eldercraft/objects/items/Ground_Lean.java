...
public class Ground_Lean extends ItemFood implements IHaveModel{
	public Ground_Lean(String name, int amount, boolean isWolfFood, PotionEffect... potionEffects){
