...
public class Patty_RawLean extends ItemFood implements IHaveModel{
	public Patty_RawLean(String name, int amount, boolean isWolfFood, PotionEffect... potionEffects){
