...
public class Patty_RawMutton extends ItemFood implements IHaveModel{
	public Patty_RawMutton(String name, int amount, boolean isWolfFood, PotionEffect... potionEffects){
