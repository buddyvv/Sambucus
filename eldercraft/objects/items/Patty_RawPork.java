...
public class Patty_RawPork extends ItemFood implements IHaveModel{
	public Patty_RawPork(String name, int amount, boolean isWolfFood, PotionEffect... potionEffects){
