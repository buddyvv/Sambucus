...
public class Ground_Pork extends ItemFood implements IHaveModel{
	public Ground_Pork(String name, int amount, boolean isWolfFood, PotionEffect... potionEffects){
