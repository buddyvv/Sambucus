...
public class Patty_RawBeef extends ItemFood implements IHaveModel{
	
	
	
	public Patty_RawBeef(String name, int amount, boolean isWolfFood, PotionEffect... potionEffects){
